...
"urn:pubid:dita4publishers.org:modules:dita:modules:d4p_enumerationTopicDomain" 
"d4p_enumerationTopicDomain.mod"
>
%d4p_enumerationTopic-d-def;

<!ENTITY % d4p_bibbase-d-def     PUBLIC 
"urn:pubid:dita4publishers.org:doctypes:dita:modules:d4p_bibbaseDomain" 
"d4p_bibbaseDomain.mod"
>
%d4p_bibbase-d-def;

<!ENTITY % d4p_simpleBib-d-def     PUBLIC 
"urn:pubid:dita4publishers.org:doctypes:dita:modules:d4p_simplebib" 
"d4p_simplebibDomain.mod"
>
%d4p_simpleBib-d-def;

<!ENTITY % d4p_formatting-d-def     PUBLIC 
"urn:pubid:dita4publishers.org:doctypes:dita:modules:d4p_formattingDomain" 
...
"urn:pubid:dita4publishers.org:doctypes:dita:modules:d4p_mediaDomain" 
"d4p_mediaDomain.mod"
>
%d4p_media-d-def;

<!ENTITY % d4p_classification-d-def     PUBLIC 
"urn:pubid:dita4publishers.org:doctypes:dita:modules:d4p_classificationDomain" 
"d4p_classificationDomain.mod"
>
%d4p_classification-d-def;

<!ENTITY % d4p_pubcontent-d-def    PUBLIC 
"urn:pubid:dita4publishers.org:doctypes:dita:modules:d4p_pubcontentDomain" 
"d4p_pubcontentDomain.mod"                                                
>
%d4p_pubcontent-d-def;

<!ENTITY % d4p_ruby-d-def    PUBLIC 
"urn:pubid:dita4publishers.org:doctypes:dita:modules:d4p_rubyDomain" 
"d4p_rubyDomain.mod"                                                
>
%d4p_ruby-d-def;
...
"urn:pubid:dita4publishers.org:doctypes:dita:modules:d4p_verseDomain" 
"d4p_verseDomain.mod"                                                
>
%d4p_verse-d-def;
